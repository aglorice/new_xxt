...
#### 5.自行打包生成exe可执行程序🚀
```bash
pyinstaller --noconfirm --onedir --console --name "xxt" --add-data "E:/pyinster-xxt/new_xxt/answers;answers/" --add-data "E:/pyinster-xxt/new_xxt/img;img/" --add-data "E:/pyinster-xxt/new_xxt/LICENSE;." --add-data "E:/pyinster-xxt/new_xxt/README.md;." --add-data "E:/pyinster-xxt/new_xxt/user.json;."  "E:/pyinster-xxt/new_xxt/main.py"
```
#### 6.使用爬取功能去爬取已完成的作业的账号，得到答案文件后，你可以选择将得到的json文件移动到`answers`文件下，然后使用完成作业的功能即可。使用批量功能前，请提前配置 `user.json`
